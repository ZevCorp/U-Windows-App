...
/// <summary>
/// QUÉ SUPERFICIES PUEDEN MANDAR SU TEXTO A JEV. Promesa 349 (spec 046).
/// </summary>
/// <remarks>
/// NACE EN LA FASE 4 CON SOLO EL VALOR POR DEFECTO, y no es un hueco olvidado: <c>ElegirConModelo</c> (348) la
