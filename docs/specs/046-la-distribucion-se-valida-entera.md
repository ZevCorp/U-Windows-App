...
Estado: **en construcción** —las nueve promesas y la 289 en verde desde la fase 9; faltan `/verifica` y el nivel 4— · Spec 046 · 2026-09-22 · Rama `jero/jev-la-distribucion-se-valida-entera` ·
...
VALIDAR  RespuestaDeJev.Validar(json, idsQueViajaron): la distribución ENTERA (388), TODAS las violaciones nombradas
   ...
   ▼
PULSAR   UnPasoDecidido: candidatas = elegida + segunda, ambas por EsPeligrosa (390) ANTES del Take
   ▼
...
- [x] Todas las promesas verdes (`.\scripts\contrato-del-grafo.ps1` → CONTRATO INTACTO, 307 verdes, 2026-09-22, fase 9)
- [x] Un sabotaje por promesa, verificado por diff, con el veredicto literal pegado aquí (en la fila **Hecho** de cada fase, 1 a 9)
