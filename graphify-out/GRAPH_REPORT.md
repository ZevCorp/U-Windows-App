...
## Corpus Check
- 212 files · ~383,004 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3913 nodes · 8136 edges · 316 communities (179 shown, 137 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 367 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf0e8f27`
...
## Communities (316 total, 137 thin omitted)
...
### Community 7 - "AgentLoop.cs"
Cohesion: 0.12
Nodes (6): U.WindowsClient.Capture, U.WindowsClient.Telemetry, U.WindowsClient.Actions, U.WindowsClient.Voice, U.WindowsClient.Mcp, U.WindowsClient.Agent
...
Cohesion: 0.16
Nodes (11): SurfaceAligner, string, PlanStep, SurfaceIdentity, Func, IReadOnlyList, List, Task (+3 more)
...
Cohesion: 0.19
Nodes (8): IEnumerable, IReadOnlyList, DryRunFinding, DryRunLevel, DryRunReport, WorkflowDryRun, CancellationToken, Dictionary
...
### Community 45 - "WorkflowTeachSession"
Cohesion: 0.16
...
### Community 65 - ".EjecutarNucleoAsync"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (8): DllImport, IntPtr, BackendBody, BackendZone, CollapsedGroup, ContextZone, VoiceDotGrupo, StackPanel
...
Cohesion: 0.06
Nodes (23): Atribucion, ConcurrentDictionary, Mapeador, Mapeador.Pruebas, long, int, List, Contrato (+15 more)
...
### Community 101 - "U.WindowsClient.Diagnostics"
Cohesion: 0.11
Nodes (8): U.WindowsClient.Backend, U.WindowsClient.Ui, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.WindowsClient.Teach, U.WindowsClient.SystemApi, U.Graph, ContratoDelGrafo
...
Cohesion: 0.08
Nodes (12): Binding, Point, Rect, CancellationToken, HttpClient, IReadOnlyList, Task, ClinicalBridge (+4 more)
...
Cohesion: 0.12
Nodes (8): bool, Dictionary, Func, IReadOnlyDictionary, string, UiaReader, UiaSurface, SurfaceMapTools
...
### Community 276 - "U.Graph.Surfaces"
Cohesion: 0.14
Nodes (5): U.WindowsClient.Uia, U.Graph.Surfaces, U.WindowsClient.Domain, IEnumerable, Fingerprints

### Community 280 - "MapaVivo"
Cohesion: 0.14
Nodes (10): ClickWatcher, ProyectorNeo4j, Timer, Etiqueta, int, IReadOnlyList, List, Selector (+2 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `VideoLibraryWindow`, `Window`, `Plata`, `Window`, `.OnLoaded`, `.SetDirectIndex`, `MapaVivo`, `.RefreshMood`, `NarradorDelArquitecto`, `RoutedEventArgs`, `GlobalHotkeys`, `SurfaceMap`, `.OnInputKey`, `.ToggleCollapsed`, `Ventana`, `IDisposable`, `ProyectorNeo4j`, `Contrato`, `U.WindowsClient.Diagnostics`, `ServidorDelNucleo`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `WorkflowLibraryWindow` connect `WorkflowLibraryWindow` to `U.WindowsClient.Diagnostics`, `BackendClient`, `WorkflowTeachSession`, `Window`, `Window`, `.RunAsync`, `GraphClient`, `SapGuiSurface`, `UiaSurface`, `GraphObservation`, `VideoLibrary`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `.Session`, `SurfaceLocator`, `IUiSurface`, `dynamic`, `.ReadTreeSelections`, `.PumpMain`, `.Execute`, `.Str`, `SapInspectorReader`, `U.Graph.Surfaces`, `SapComEvents`, `WorkflowLibraryWindow`, `AgentLoop`?**
