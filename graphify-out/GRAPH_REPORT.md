...
## Corpus Check
- 202 files · ~366,407 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3783 nodes · 7880 edges · 319 communities (178 shown, 141 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 315 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d8108c2d`
...
## Communities (319 total, 141 thin omitted)
...
Cohesion: 0.18
Nodes (13): DllImport, HashSet, HookProc, int, IntPtr, object, StringBuilder, uint (+5 more)
...
Cohesion: 0.11
Nodes (8): U.WindowsClient.Backend, U.WindowsClient.Ui, U.WindowsClient.Uia, U.Graph.Surfaces, U.WindowsClient.Domain, U.WindowsClient.Diagnostics, U.WindowsClient.Teach, U.Graph

### Community 9 - "SurfaceMapTools"
Cohesion: 0.13
Nodes (9): bool, Dictionary, int, List, string, UiaReader, UiaSurface, RECT (+1 more)
...
### Community 32 - ".CrawlAsync"
Cohesion: 0.22
Nodes (4): AppInstalada, Color, IReadOnlyDictionary, Task
...
### Community 41 - ".LeerInterrupcion"
Cohesion: 0.60
Nodes (3): Opciones, Textos, Titulo
...
### Community 45 - "SurfaceMap"
Cohesion: 0.13
Nodes (13): NodeInfo, Click, DateTime, Dictionary, int, IReadOnlyDictionary, string, EdgeInfo (+5 more)
...
Cohesion: 0.19
Nodes (7): MouseEventArgs, SolidColorBrush, CollapsedGroup, RootPanel, ZonaChat, ZonaVoz, Grid

### Community 52 - "gemini.ts"
Cohesion: 0.29
Nodes (14): asArr(), asInt(), asObj(), asStr(), builtinFns(), COMPUTER_FNS, fn(), gemHttp() (+6 more)

### Community 53 - "TeachSession"
Cohesion: 0.14
...
Cohesion: 0.12
Nodes (15): U.WindowsClient.Clinical, Field, ClinicalValue, HashSet, IReadOnlyList, Key, List, string (+7 more)
...
Cohesion: 0.12
Nodes (12): DateTime, HashSet, Hop, IEnumerable, List, EdgeBronce, EdgeInfo, Ensenanza (+4 more)
...
### Community 69 - ".OnLoaded"
Cohesion: 0.08
Nodes (9): Binding, Point, Rect, CancellationToken, HttpClient, IReadOnlyList, Task, ClinicalBridge (+1 more)

### Community 70 - "FaceGestures"
Cohesion: 0.12
...
Cohesion: 0.14
Nodes (10): Action, Brush, Button, ContentControl, int, Fila, Ventana, Stack (+2 more)
...
### Community 90 - "ConsolaViva"
Cohesion: 0.05
Nodes (32): BlockingCollection, CancellationToken, Cobertura, ConAccion, Declarados, Detalle, Escenario, Ok (+24 more)
...
### Community 112 - "Grafo"
Cohesion: 0.08
Nodes (20): bool, Nucleo.Pruebas, Nucleo, Func, HttpClient, IReadOnlyList, Action, int (+12 more)
...
Cohesion: 0.08
Nodes (25): Alternatives, Click, ClickWatcher, ControlType, Grupo, Info, Label, Selector (+17 more)
...
Cohesion: 0.09
Nodes (21): Border, CancellationTokenSource, CarruselDeApps, DispatcherTimer, DllImport, DockPanel, IntPtr, NarradorDelArquitecto (+13 more)
...
### Community 165 - "Window"
Cohesion: 0.12
Nodes (14): Paso, Ventana, Visto, Window, Button, Color, IReadOnlyList, List (+6 more)
...
Cohesion: 0.04
Nodes (43): AgentLoop, AtajoPorGolpes, BackendClient, ClinicalBridge, Config, FaceTheme, GlobalHotkeys, GraphClient (+35 more)

### Community 171 - ".RetryAllAsync"
Cohesion: 0.28
Nodes (6): Entry, CancellationToken, List, Task, Entry, PendingFinish

### Community 172 - "AgentLoop.cs"
Cohesion: 0.15
...
### Community 176 - ".RefreshMood"
Cohesion: 0.18
Nodes (3): FaceMood, TranslateTransform, Action

### Community 177 - "HighlightOverlay"
Cohesion: 0.22
...
### Community 274 - ".EstaDelante"
Cohesion: 0.38
Nodes (3): DllImport, IntPtr, UIntPtr

### Community 275 - "OlvidarJerarquias"
Cohesion: 0.22
...
### Community 305 - "U.WindowsClient.Navigation"
Cohesion: 0.17
Nodes (3): U.WindowsClient.Capture, U.WindowsClient.Navigation, ContratoDelGrafo

### Community 306 - "FocusRunningStrategy"
Cohesion: 0.44
Nodes (4): DllImport, int, IntPtr, FocusRunningStrategy

### Community 311 - "Programa.cs"
Cohesion: 0.40
Nodes (3): Maqueta, Programa, STAThread

### Community 313 - ".OnInputKey"
Cohesion: 0.40
Nodes (4): KeyEventArgs, ClinicalCodeBox, Input, TextBox

### Community 314 - "InputUnion"
Cohesion: 0.67
...
## Knowledge Gaps
- **432 isolated node(s):** `Nucleo.Pruebas`, `CONTINUAR`, `CHAT`, `SOLO_CHAT`, `MODELOS` (+427 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `VideoLibraryWindow`, `SurfaceMap`, `Window`, `.ToggleCollapsed`, `GraphExplorerWindow`, `NarradorDelArquitecto`, `.CrawlAsync`, `Window`, `RoutedEventArgs`, `.RefreshMood`, `U.WindowsClient.Navigation`, `HighlightOverlay`, `.CrecerPastilla`, `GlobalHotkeys`, `.OnInputKey`, `IDisposable`, `SurfaceMap`, `.OnLoaded`, `Plata`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `.ReadTreeSelections`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `dynamic`, `.Execute`, `U.WindowsClient.Diagnostics`, `.Str`, `SapInspectorReader`, `WorkflowLibraryWindow`, `SapComEvents`, `.Session`, `AgentLoop`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `WorkflowLibraryWindow` connect `WorkflowLibraryWindow` to `VideoLibraryWindow`, `Window`, `Window`, `U.WindowsClient.Diagnostics`, `BackendClient`, `.RunAsync`, `GraphClient`, `SapGuiSurface`, `UiaSurface`, `GraphObservation`, `WorkflowTeachSession`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **What connects `Nucleo.Pruebas`, `CONTINUAR`, `CHAT` to the rest of the system?**
