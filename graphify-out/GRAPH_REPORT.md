...
## Corpus Check
- 167 files · ~298,562 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3004 nodes · 6234 edges · 167 communities (149 shown, 18 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 256 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4db31e92`
...
Cohesion: 0.07
Nodes (26): return, Alternatives, Aristas, Click, ControlType, DateTime, Dictionary, From (+18 more)

### Community 8 - "U.WindowsClient.Diagnostics"
Cohesion: 0.11
Nodes (9): U.WindowsClient.Backend, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.WindowsClient.Teach, U.WindowsClient.Voice, U.Graph, ContratoDelGrafo, Ensenanza (+1 more)
...
### Community 16 - ".Edges"
Cohesion: 0.16
Nodes (8): Contrato, int, STAThread, string, From, Info, List, To
...
Cohesion: 0.11
Nodes (9): U.WindowsClient.Uia, U.WindowsClient.Telemetry, U.Graph.Surfaces, U.WindowsClient.Domain, U.WindowsClient.Actions, U.WindowsClient.Mcp, U.WindowsClient.Agent, IEnumerable (+1 more)
...
Cohesion: 0.22
Nodes (9): U.WindowsClient.Capture, Clave(), CancellationToken, IntPtr, IReadOnlyDictionary, Task, UiElement, EnsenarAsync() (+1 more)
...
Cohesion: 0.08
Nodes (26): EdgeInfo, NodeInfo, Hop, Alternatives, Click, ControlType, DateTime, Dictionary (+18 more)
...
### Community 67 - "U.WindowsClient.SystemApi"
Cohesion: 0.11
Nodes (11): U.WindowsClient.SystemApi, IReadOnlyList, AppInstalada, ImageSource, IReadOnlyList, List, Task, TextBox (+3 more)
...
### Community 78 - ".Log"
Cohesion: 0.09
Nodes (15): U.WindowsClient.Update, UpdateManager, VelopackAsset, Aristas, Nodos, Aristas, Nodos, CancellationToken (+7 more)
...
Cohesion: 0.06
Nodes (27): IDisposable, SpeechSynthesizer, VoiceActivity, bool, DateTime, DllImport, Gancho, int (+19 more)
...
Cohesion: 0.10
Nodes (14): Puede, Version, CancellationToken, Porque, Task, Arquitecto, DateTime, IReadOnlyList (+6 more)
...
Cohesion: 0.10
Nodes (17): Alternatives, ControlType, DateTime, Dictionary, Grupo, IEnumerable, int, IReadOnlyDictionary (+9 more)
...
### Community 108 - ".AppsConJerarquia"
Cohesion: 0.28
Nodes (6): App, Cuantas, DeHumano, Etiqueta, IReadOnlyList, Nivel
...
Cohesion: 0.11
Nodes (16): uint, MSLLHOOKSTRUCT, bool, DispatcherTimer, DllImport, double, EventArgs, int (+8 more)
...
### Community 129 - ".GetForegroundWindow"
Cohesion: 0.24
...
Cohesion: 0.12
Nodes (12): Marca, DllImport, int, IReadOnlyList, List, object, POINT, Timer (+4 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `UiaSurface` connect `UiaSurface` to `GraphCrawler`, `U.Graph.Surfaces`, `.GetForegroundWindow`, `.ParseKeySpec`, `SurfaceMapTools`, `AutomationElement`, `IUiSurface`, `.Describe`, `SurfaceAvailability`, `WorkflowLibraryWindow`, `IntPtr`, `AgentLoop`, `UiaSelector`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `WorkflowLibraryWindow` connect `WorkflowLibraryWindow` to `Window`, `VideoLibraryWindow`, `Backend HTTP Client`, `U.WindowsClient.Diagnostics`, `WorkflowTeachSession`, `NoteBox`, `.RunAsync`, `GraphObservation`, `Graph Backend HTTP Client`, `SapGuiSurface`, `UiaSurface`, `.RunAutofillMatchAsync`, `Fill Preview Dialog`, `GraphConfig`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `U.Graph.Surfaces`, `.PumpMain`, `SurfaceLocator`, `.Walk`, `List`, `.ReadTreeSelections`, `.Str`, `IUiSurface`, `SapInspectorReader`, `dynamic`, `SAP COM Event Binding`, `WorkflowLibraryWindow`, `AgentLoop`?**
