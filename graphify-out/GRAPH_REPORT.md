...
## Corpus Check
- 170 files · ~306,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3441 nodes · 7303 edges · 229 communities (161 shown, 68 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 312 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e14a7e8f`
...
Cohesion: 0.10
Nodes (8): Stack, bool, Func, int, IReadOnlyDictionary, string, RECT, SurfaceMapTools
...
Cohesion: 0.10
Nodes (12): U.WindowsClient.Capture, U.WindowsClient.Uia, U.WindowsClient.Telemetry, U.Graph.Surfaces, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.WindowsClient.Voice, U.WindowsClient.Mcp (+4 more)
...
Cohesion: 0.29
Nodes (4): Caja, IReadOnlyList, Point, Que
...
### Community 106 - ".ExitsFrom"
Cohesion: 0.17
Nodes (7): IEnumerable, Hop, List, Dictionary, Etiqueta, From, To
...
Cohesion: 0.17
Nodes (9): Canvas, int, IReadOnlyDictionary, IReadOnlyList, Rect, Rectangle, UiElement, List (+1 more)

### Community 109 - "U.WindowsClient.Ui"
Cohesion: 0.13
Nodes (6): U.WindowsClient.Ui, U.WindowsClient.Clinical, IEasingFunction, MuelleEase, ProfundidadClasica, ThrowEase
...
### Community 181 - ".GetWindowLong"
Cohesion: 0.47
Nodes (3): DllImport, EventArgs, IntPtr

### Community 183 - ".OnInputKey"
Cohesion: 0.40
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `TeachSession`, `ClickWatcher`, `.SetDirectIndex`, `Window`, `UiaReader`, `GraphExplorerWindow`, `.OnLoaded`, `GraphClient`, `SapGuiSurface`, `WorkflowTeachSession`, `AtajoPorGolpes`, `WorkflowMapWindow`, `UiaSurface`, `AgentLoop`, `U.WindowsClient.Diagnostics`, `GlobalHotkeys`, `.ToggleCollapsed`, `.WireMenu`, `UI Inspector Hooks`, `GraphObservation`, `.CrecerPastilla`, `.BindPressure`, `.OnInputKey`, `BackendClient`, `WorkflowLibraryWindow`, `StepDebuggerWindow`, `LogWindow`, `Locator Badge Overlay`, `Window`, `.RefreshMood`, `SurfaceMap`, `VoiceIO`, `.Aplicar`, `.Log`, `PanelDeAcciones`, `GeminiLive`?**
  _High betweenness centrality (0.222) - this node is a cross-community bridge._
- **Why does `UiaSurface` connect `UiaSurface` to `GraphCrawler`, `U.WindowsClient.Diagnostics`, `.GetForegroundWindow`, `.ParseKeySpec`, `SurfaceMapTools`, `WorkflowLibraryWindow`, `AutomationElement`, `.FindIn`, `.Describe`, `FaceWindow`, `IntPtr`, `AgentLoop`, `UiaSelector`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `U.WindowsClient.Diagnostics`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `.Str`, `dynamic`, `SapSelector`, `.ReadTreeSelections`, `.Session`, `WorkflowLibraryWindow`, `SapInspectorReader`, `AtajoPorGolpes`, `FaceWindow`, `AgentLoop`?**
