...
## Corpus Check
- 172 files · ~317,834 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3505 nodes · 7359 edges · 263 communities (176 shown, 87 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40cb8ea8`
...
## Communities (263 total, 87 thin omitted)

### Community 0 - "GraphCrawler"
Cohesion: 0.05
Nodes (39): Alternativas, CancellationToken, Cromo, Entrable, Frente, From, Grupo, Queue (+31 more)
...
### Community 8 - ".WireMenu"
Cohesion: 0.09
Nodes (8): SizeChangedEventArgs, TranslateTransform, FaceMood, BackendBody, BarPanel, MouseButtonEventArgs, RotateTransform, UIElement

### Community 9 - "DllImport"
Cohesion: 0.16
Nodes (6): DllImport, EnumProc, Func, IntPtr, RECT, StringBuilder
...
### Community 12 - "Window"
Cohesion: 0.04
Nodes (78): ActivatorChevron, ActivatorRot, AprendizajeBtn, AutonomoBtn, BackendChevron, BackendDot, BackendHeader, BackendRot (+70 more)
...
### Community 16 - "GlobalHotkeys"
Cohesion: 0.16
Nodes (10): EventArgs, Dictionary, DllImport, HwndSource, int, IntPtr, List, uint (+2 more)

### Community 17 - ".RunAsync"
Cohesion: 0.14
Nodes (14): SurfaceAligner, JsonElement, string, PlanStep, SurfaceIdentity, CancellationToken, Dictionary, Func (+6 more)
...
Cohesion: 0.08
Nodes (18): Config, HorizontalAlignment, SoundPlayer, bool, CancellationToken, CancellationTokenSource, Color, DateTime (+10 more)
...
### Community 41 - ".Marcados"
Cohesion: 0.40
Nodes (4): Caja, Rect, Que, IReadOnlyList
...
### Community 50 - "WorkflowTeachSession"
Cohesion: 0.20
...
### Community 70 - "AutomationElement"
Cohesion: 0.12
...
### Community 78 - "Gestures"
Cohesion: 0.27
Nodes (5): byte, DllImport, uint, UIntPtr, Gestures

### Community 79 - "U.WindowsClient.Diagnostics"
Cohesion: 0.12
Nodes (6): U.WindowsClient.Ui, U.WindowsClient.Clinical, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.WindowsClient.Voice, U.WindowsClient.SystemApi
...
### Community 96 - ".LearnTraversal"
Cohesion: 0.17
Nodes (7): ContratoDelGrafo, Contrato, int, STAThread, string, Aristas, Nodos
...
Cohesion: 0.14
Nodes (5): AppInstalada, Visual, IReadOnlyDictionary, Rect, Pantallas

### Community 111 - "GraphClient.cs"
Cohesion: 0.50
...
### Community 123 - ".Log"
Cohesion: 0.09
Nodes (20): bool, CancellationTokenSource, ClientWebSocket, ConsumoVivo, DateTime, double, HashSet, int (+12 more)
...
Cohesion: 0.12
Nodes (14): App, Cuantas, DeHumano, Etiqueta, IReadOnlyList, Nivel, Dictionary, Etiqueta (+6 more)
...
### Community 174 - "PasoAPaso"
Cohesion: 0.12
Nodes (13): Paso, Ventana, Visto, Button, Color, IReadOnlyList, List, Task (+5 more)
...
### Community 192 - ".EstaDelante"
Cohesion: 0.38
Nodes (3): DllImport, IntPtr, UIntPtr

### Community 194 - "SapSelector"
Cohesion: 0.31
...
## Knowledge Gaps
- **377 isolated node(s):** `ConsumoVivo`, `Hop`, `Ensenanza`, `Stored`, `Hop` (+372 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `VideoLibraryWindow`, `ClickWatcher`, `WorkflowLibraryWindow`, `Updater`, `.WireMenu`, `Window`, `UiaReader`, `.OnLoaded`, `GlobalHotkeys`, `GraphClient`, `SapGuiSurface`, `UiaSurface`, `WorkflowMapWindow`, `AgentLoop`, `SurfaceMap`, `GraphObservation`, `.ToggleCollapsed`, `UI Inspector Hooks`, `WorkflowTeachSession`, `.CrecerPastilla`, `VoiceIO`, `AtajoPorGolpes`, `BackendClient`, `StepDebuggerWindow`, `U.WindowsClient.Diagnostics`, `LogWindow`, `Locator Badge Overlay`, `Window`, `.OnInputKey`, `GraphConfig`, `GraphExplorerWindow`, `.SetDirectIndex`, `.Aplicar`, `PanelDeAcciones`, `.Log`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `U.Graph.Surfaces`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `.Str`, `dynamic`, `WorkflowLibraryWindow`, `SapSelector`, `.Session`, `.ReadTreeSelections`, `SapInspectorReader`, `AtajoPorGolpes`, `FaceWindow`, `AgentLoop`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `GraphExplorerWindow` connect `GraphExplorerWindow` to `.DibujarConProfundidad`, `HighlightOverlay`, `SurfaceLocator`, `Window`, `AppAligner`, `.CrawlAsync`, `U.WindowsClient.Diagnostics`, `Propio`, `CarruselDeApps`, `.DibujarVersiones`, `FaceWindow`, `DllImport`, `.Log`, `SurfaceMap`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **What connects `ConsumoVivo`, `Hop`, `Ensenanza` to the rest of the system?**
