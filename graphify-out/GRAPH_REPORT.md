...
## Corpus Check
- 234 files · ~422,245 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4340 nodes · 9038 edges · 280 communities (206 shown, 74 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 485 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80c64d78`
...
Cohesion: 0.12
Nodes (15): SurfaceLocation, Uri, bool, Dispatcher, DispatcherTimer, DllImport, int, IntPtr (+7 more)
...
Cohesion: 0.24
Nodes (6): EnumWindowsProc, StringBuilder, DllImport, int, IntPtr, AppAligner
...
Cohesion: 0.24
Nodes (4): Action, FaceMood, TranslateTransform, UIElement
...
Cohesion: 0.29
Nodes (5): Caja, Func, IReadOnlyList, Que, Rect
...
### Community 54 - "Button"
Cohesion: 0.06
Nodes (28): RoutedEventArgs, AprendizajeBtn, AutonomoBtn, CollarBtn, CollarModoBtn, ExplorerBtn, FullTooltipsBtn, InspectorBtn (+20 more)
...
### Community 58 - "WorkflowLibraryWindow"
Cohesion: 0.20
Nodes (9): TeachBtn, bool, CancellationTokenSource, DispatcherTimer, EventArgs, List, string, Task (+1 more)
...
Cohesion: 0.06
Nodes (33): Alternatives, App, Aristas, Click, ControlType, Cuantas, DateTime, DeHumano (+25 more)
...
### Community 65 - "EjecutorDeExportaciones"
Cohesion: 0.18
Nodes (11): CancellationToken, CancellationTokenSource, Dispatcher, Func, HttpClient, HttpRequestMessage, IReadOnlyList, JsonElement (+3 more)
...
Cohesion: 0.17
Nodes (9): bool, CancellationTokenSource, Dictionary, HttpClient, int, string, StringBuilder, RellenadorSap (+1 more)

### Community 74 - "Explorador"
Cohesion: 0.20
Nodes (6): DllImport, int, IntPtr, IReadOnlyList, Entrada, Explorador

### Community 75 - "AppsInstaladas"
Cohesion: 0.27
Nodes (9): SHFILEINFO, DllImport, ImageSource, int, IntPtr, string, uint, AppsInstaladas (+1 more)

### Community 76 - "SurfaceMap"
Cohesion: 0.12
Nodes (14): NodeInfo, Click, DateTime, Dictionary, int, IReadOnlyDictionary, string, EdgeBronce (+6 more)
...
### Community 78 - ".RellenarConNotaAsync"
Cohesion: 0.30
Nodes (8): Escritos, SinLlenar, CancellationToken, IReadOnlyList, JsonElement, List, Task, LoEscrito

### Community 79 - "Ventana"
Cohesion: 0.10
Nodes (18): ContentControl, Maqueta, Brush, Button, ControlTemplate, Dictionary, Func, int (+10 more)

### Community 80 - "Patrones de desarrollo: cómo se escribe código aquí"
Cohesion: 0.18
...
### Community 92 - ".Edges"
Cohesion: 0.18
Nodes (6): From, HashSet, Hop, IEnumerable, Info, To
...
Cohesion: 0.18
Nodes (4): int, List, Contrato, Func

### Community 96 - "U.WindowsClient.Diagnostics"
Cohesion: 0.11
Nodes (8): U.WindowsClient.Clinical, U.WindowsClient.Uia, U.Graph.Surfaces, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.Graph, ContratoDelGrafo, ProfundidadClasica
...
Cohesion: 0.12
Nodes (15): Cuerpo, Etiqueta, Grafo, HttpListener, HttpListenerRequest, Porque, Selector, Tipo (+7 more)

### Community 106 - "BackendClient"
Cohesion: 0.17
Nodes (14): HttpContent, bool, CancellationToken, HttpClient, HttpResponseMessage, HttpStatusCode, JsonSerializerOptions, string (+6 more)
...
Cohesion: 0.09
Nodes (10): Binding, FaceTheme, Point, Rect, HttpClient, ClinicalBridge, ClinicalPairBtn, VideoLlmToggle (+2 more)
...
Cohesion: 0.12
Nodes (8): CancellationToken, Func, Task, DllImport, IntPtr, string, StringBuilder, Escritorio
...
Cohesion: 0.08
Nodes (20): ClientWebSocket, ConsumoVivo, HashSet, IReadOnlyDictionary, LiveVideo, object, SemaphoreSlim, SurfaceMapTools (+12 more)
...
### Community 129 - ".OnApplyMatch"
Cohesion: 0.28
Nodes (4): ReloadBtn, RunBtn, RoutedEventArgs, Button
...
### Community 144 - "WorkflowTeachSession"
Cohesion: 0.10
Nodes (12): EventHandler, ValueTask, CancellationToken, DllImport, int, IntPtr, string, Task (+4 more)
...
Cohesion: 0.08
Nodes (9): bool, Dictionary, int, IReadOnlyDictionary, Point, Stack, string, RECT (+1 more)
...
### Community 166 - "Inspector visual (overlay click-through)"
Cohesion: 0.22
...
Cohesion: 0.03
Nodes (59): AgentLoop, AtajoPorGolpes, BackendClient, Button, ClinicalBridge, Color, Config, DictadoSoniox (+51 more)

### Community 171 - ".Calcular"
Cohesion: 0.08
Nodes (20): Cromo, App, Cuantas, DeHumano, Etiqueta, IReadOnlyList, Nivel, Nivel (+12 more)
...
### Community 173 - ".AppDe"
Cohesion: 0.14
Nodes (6): AppInstalada, Button, Color, Task, Pantallas, Task

### Community 174 - ".SetStatus"
Cohesion: 0.12
Nodes (6): MouseButtonEventArgs, CheckUpdateBtn, DryRunBtn, MicBtn, StopBtn, CancellationToken
...
Cohesion: 0.17
Nodes (8): Window, Brush, Button, TaskCompletionSource, FillPreviewWindow, Button, TextBlock, PanelDelCollar
...
### Community 196 - ".FetchAsync"
Cohesion: 0.50
Nodes (3): CancellationToken, IReadOnlyList, Task

### Community 197 - ".Log"
Cohesion: 0.10
Nodes (14): Busqueda, U.WindowsClient.Update, Detalle, Que, StartupEventArgs, Task, TimeSpan, UpdateManager (+6 more)

### Community 198 - "FocusRunningStrategy"
Cohesion: 0.44
...
### Community 204 - "U.WindowsClient.SystemApi"
Cohesion: 0.22
Nodes (4): U.WindowsClient.SystemApi, IEnumerable, string, InstalledApps

### Community 205 - "Etapa 6 — El paso a `main`"
Cohesion: 0.29
...
### Community 208 - "El aviso — lo que se subió, contado al equipo"
Cohesion: 0.29
...
### Community 217 - "Etapa 5 — Verificar"
Cohesion: 0.29
...
Cohesion: 0.06
Nodes (25): BluetoothLEDevice, GattCharacteristic, GattDeviceService, GattSession, GattValueChangedEventArgs, IBuffer, IOpusDecoder, short (+17 more)

### Community 251 - "Todo push deja un aviso en `#miracle-updates`"
Cohesion: 0.33
...
### Community 255 - "Presentacion"
Cohesion: 0.33
Nodes (3): U.WindowsClient.Onboarding, string, Presentacion

### Community 256 - "Árboles (`GuiTree`)"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (11): ProyectorNeo4j, SinColgarse, Timer, bool, ClickWatcher, DateTime, double, Func (+3 more)

### Community 281 - ".OnWorkflowListSelected"
Cohesion: 0.50
Nodes (3): SelectionChangedEventArgs, WorkflowListBox, ListBox

### Community 295 - "AgentLoop.cs"
Cohesion: 0.11
Nodes (9): U.WindowsClient.Capture, U.WindowsClient.Telemetry, U.WindowsClient.Actions, U.WindowsClient.Mcp, U.WindowsClient.Agent, bool, object, string (+1 more)
...
## Knowledge Gaps
- **560 isolated node(s):** `U.WindowsClient.Onboarding`, `ConsumoVivo`, `Mapeador.Pruebas`, `Via`, `Plan` (+555 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `.OnWorkflowListSelected`, `TeachSession`, `U.WindowsClient.Voice`, `Window`, `.SetStatus`, `.OnLoaded`, `WorkflowTeachSession`, `Window`, `.UpdateChip`, `IDisposable`, `Button`, `GlobalHotkeys`, `GeminiLive`, `.CrecerPastilla`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `Window` connect `Window` to `FaceWindow`, `.SetStatus`, `.OnLoaded`, `WorkflowTeachSession`, `Button`, `.OnWorkflowListSelected`, `.CrecerPastilla`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `UiaSurface` connect `UiaSurface` to `GraphCrawler`, `U.WindowsClient.Diagnostics`, `IUiSurface`, `IntPtr`, `AutomationElement`, `.Describe`, `SurfaceMapTools`, `GraphExplorerWindow`, `UiaSelector`, `WorkflowLibraryWindow`, `WorkflowRecorder`, `AgentLoop`, `.GetForegroundWindow`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **What connects `U.WindowsClient.Onboarding`, `ConsumoVivo`, `Mapeador.Pruebas` to the rest of the system?**
