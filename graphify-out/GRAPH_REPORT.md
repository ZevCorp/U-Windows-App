...
## Corpus Check
- 176 files · ~338,926 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3509 nodes · 7537 edges · 183 communities (165 shown, 18 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 304 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e4a7116f`
...
5. `GraphExplorerWindow` - 88 edges
6. `Window` - 82 edges
7. `SurfaceMap` - 81 edges
8. `SurfaceMap` - 60 edges
9. `SurfaceMap` - 59 edges
10. `U.WindowsClient.Diagnostics` - 48 edges
...
### Community 7 - ".ObserveExits"
Cohesion: 0.17
Nodes (5): Alternatives, ControlType, Grupo, Label, Selector

### Community 8 - "U.WindowsClient.Teach"
Cohesion: 0.20
Nodes (4): U.WindowsClient.Backend, U.WindowsClient.Teach, JsonElement, WorkflowSummary

### Community 9 - "SurfaceMapTools"
Cohesion: 0.08
Nodes (12): Stack, bool, Dictionary, int, IReadOnlyDictionary, List, Opciones, string (+4 more)
...
### Community 43 - ".Log"
Cohesion: 0.09
Nodes (24): ContratoDelGrafo, AtrasEsEfimero(), CromoDesdeCualquierParte(), STAThread, DosPuertasDosAristas(), DwellYPasoDeLargo(), EnsenanzaSobrevive(), Main() (+16 more)
...
Cohesion: 0.10
Nodes (17): U.WindowsClient.Clinical, Field, ClinicalValue, HashSet, IReadOnlyList, Key, List, string (+9 more)
...
Cohesion: 0.06
Nodes (33): NodeInfo, Alternatives, App, Aristas, Click, ControlType, Cuantas, DateTime (+25 more)
...
Cohesion: 0.11
Nodes (9): Caja, DllImport, EnumProc, Func, IntPtr, IReadOnlyList, Point, Que (+1 more)
...
### Community 91 - "Window"
Cohesion: 0.25
Nodes (6): Window, Button, Color, List, StackPanel, OlvidarJerarquias
...
### Community 96 - ".Edges"
Cohesion: 0.10
Nodes (15): Cobertura, ConAccion, Declarados, Pantallas, Alternatives, ControlType, From, Grupo (+7 more)
...
Cohesion: 0.10
Nodes (20): DockPanel, Screen, ScrollViewer, VistaGrafo, bool, Border, CancellationTokenSource, DateTime (+12 more)
...
### Community 144 - ".Recorrer"
Cohesion: 0.25
Nodes (5): CollapsedFace, Face, Point, Rect, FaceControl
...
Cohesion: 0.13
Nodes (13): HEAD, Click, DateTime, Dictionary, int, IReadOnlyDictionary, string, EdgeBronce (+5 more)
...
Cohesion: 0.14
Nodes (4): U.WindowsClient.Ui, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.Graph
...
## Knowledge Gaps
- **421 isolated node(s):** `CONTINUAR`, `CHAT`, `SOLO_CHAT`, `herramientas`, `PERMITIDAS` (+416 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `VideoLibraryWindow`, `ClickWatcher`, `.WireMenu`, `Window`, `UiaReader`, `.Recorrer`, `GraphClient`, `SapGuiSurface`, `FaceWindow.xaml.cs`, `UiaSurface`, `WorkflowMapWindow`, `.SetDirectIndex`, `AgentLoop`, `.FetchAsync`, `WorkflowTeachSession`, `.Aplicar`, `.Log`, `.OnInputKey`, `.RefreshMood`, `UI Inspector Hooks`, `GraphObservation`, `.CrecerPastilla`, `.BindPressure`, `GlobalHotkeys`, `StepDebuggerWindow`, `WorkflowLibraryWindow`, `LogBus`, `Locator Badge Overlay`, `AtajoPorGolpes`, `Window`, `Updater`, `VoiceIO`, `BackendClient`, `GraphExplorerWindow`, `.ToggleCollapsed`, `PanelDeAcciones`, `GeminiLive`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `UiaSurface` connect `UiaSurface` to `GraphCrawler`, `IUiSurface`, `.GetForegroundWindow`, `SurfaceMapTools`, `AutomationElement`, `GraphExplorerWindow`, `FaceWindow`, `WorkflowLibraryWindow`, `.Describe`, `U.Graph.Surfaces`, `UiaSelector`, `IntPtr`, `WorkflowRecorder`, `AgentLoop`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `.ReadTreeSelections`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `List`, `dynamic`, `.Str`, `SapInspectorReader`, `WorkflowLibraryWindow`, `FaceWindow`, `.Walk`, `U.Graph.Surfaces`, `SapComEvents`, `AgentLoop`?**
