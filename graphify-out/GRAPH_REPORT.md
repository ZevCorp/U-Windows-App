...
## Corpus Check
- 170 files · ~307,274 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3451 nodes · 7312 edges · 242 communities (165 shown, 77 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 314 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f4aac6b`
...
4. `SurfaceMapTools` - 85 edges
5. `Window` - 81 edges
6. `GraphExplorerWindow` - 77 edges
...
## Communities (242 total, 77 thin omitted)

### Community 0 - "GraphCrawler"
Cohesion: 0.06
Nodes (36): Alternativas, CancellationToken, Entrable, EnumProc, From, Grupo, Queue, Selector (+28 more)
...
Cohesion: 0.08
Nodes (7): List, Opciones, Stack, SurfaceMap, Textos, Titulo, SurfaceMapTools
...
Cohesion: 0.10
Nodes (7): U.WindowsClient.Capture, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.WindowsClient.Voice, U.WindowsClient.SystemApi, U.WindowsClient.Update, ContratoDelGrafo
...
Cohesion: 0.25
Nodes (5): Caja, Rect, Func, IReadOnlyList, Que
...
### Community 67 - "OlvidarJerarquias"
Cohesion: 0.25
...
Cohesion: 0.06
Nodes (33): bool, Border, Button, CancellationTokenSource, Canvas, CarruselDeApps, Color, DateTime (+25 more)
...
### Community 110 - ".Log"
Cohesion: 0.12
Nodes (12): AppInstalada, Escenario, Task, UpdateManager, VelopackAsset, Aristas, Nodos, IReadOnlyList (+4 more)

### Community 111 - "PasoAPaso"
Cohesion: 0.18
Nodes (10): Exception, Paso, Ventana, Visto, IReadOnlyList, List, Abandonado, PasoAPaso (+2 more)

### Community 112 - "U.WindowsClient.Ui"
Cohesion: 0.16
Nodes (6): U.WindowsClient.Backend, U.WindowsClient.Ui, U.WindowsClient.Domain, U.WindowsClient.Teach, U.Graph, ProfundidadClasica
...
Cohesion: 0.11
Nodes (5): DllImport, EventArgs, IntPtr, StringBuilder, WinEventProc
...
Cohesion: 0.24
Nodes (4): U.WindowsClient.Telemetry, U.WindowsClient.Actions, U.WindowsClient.Mcp, U.WindowsClient.Agent

### Community 175 - ".AbrirNodoAsync"
Cohesion: 0.22
Nodes (5): Cromo, Frente, Nivel, SurfaceMap, JerarquiaWeb
...
## Knowledge Gaps
- **372 isolated node(s):** `TURNOS`, `herramientas`, `corrida`, `Hop`, `Ensenanza` (+367 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `VideoLibraryWindow`, `ClickWatcher`, `.SetDirectIndex`, `Window`, `UiaReader`, `.OnLoaded`, `GraphClient`, `SapGuiSurface`, `WorkflowTeachSession`, `AtajoPorGolpes`, `WorkflowMapWindow`, `RoutedEventArgs`, `UiaSurface`, `WorkflowRecorder`, `AgentLoop`, `U.WindowsClient.Diagnostics`, `GlobalHotkeys`, `UI Inspector Hooks`, `GraphObservation`, `.CrecerPastilla`, `VideoLibrary`, `BackendClient`, `WorkflowLibraryWindow`, `StepDebuggerWindow`, `LogWindow`, `Locator Badge Overlay`, `Window`, `.RefreshMood`, `SurfaceMap`, `VoiceIO`, `GraphExplorerWindow`, `.Log`, `PanelDeAcciones`, `GeminiLive`?**
  _High betweenness centrality (0.233) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `.ReadTreeSelections`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `.Str`, `dynamic`, `.Session`, `WorkflowLibraryWindow`, `FaceWindow`, `SapInspectorReader`, `U.Graph.Surfaces`, `AtajoPorGolpes`, `AgentLoop`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `UiaSurface` connect `UiaSurface` to `GraphCrawler`, `.GetForegroundWindow`, `.ParseKeySpec`, `WorkflowLibraryWindow`, `AutomationElement`, `FaceWindow`, `.FindIn`, `.Describe`, `U.Graph.Surfaces`, `UiaSelector`, `IntPtr`, `AgentLoop`?**
