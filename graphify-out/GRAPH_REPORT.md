...
## Corpus Check
- 237 files · ~429,132 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4404 nodes · 9125 edges · 320 communities (207 shown, 113 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 487 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02402fe7`
...
4. `SurfaceMapTools` - 95 edges
5. `SurfaceMap` - 95 edges
...
## Communities (320 total, 113 thin omitted)

### Community 0 - "GraphCrawler"
Cohesion: 0.06
Nodes (34): Alternativas, Entrable, bool, CancellationToken, DllImport, EnumProc, From, Func (+26 more)
...
### Community 6 - "SurfaceMap"
Cohesion: 0.08
Nodes (25): Contrato, Assembly, int, STAThread, string, Alternatives, ControlType, DateTime (+17 more)
...
### Community 22 - "WorkflowTeachSession"
Cohesion: 0.21
Nodes (9): EventHandler, CancellationToken, DllImport, int, IntPtr, string, Task, ValueTask (+1 more)
...
### Community 32 - "Desplazamiento"
Cohesion: 0.20
Nodes (6): Hacia, ScrollPattern, DllImport, IntPtr, Desplazamiento, Hacia
...
### Community 43 - "UIA — superficie genérica de Windows"
Cohesion: 0.29
...
### Community 54 - ".AppDe"
Cohesion: 0.12
Nodes (8): Cromo, Frente, Hop, List, Nivel, JerarquiaWeb, AppInstalada, Task
...
Cohesion: 0.08
Nodes (21): Cobertura, ConAccion, Declarados, Escenario, Pantallas, Version, Aristas, Nodos (+13 more)
...
Cohesion: 0.05
Nodes (40): DockPanel, NarradorDelArquitecto, Screen, ScrollViewer, VistaGrafo, Visual, bool, Border (+32 more)
...
### Community 82 - "DllImport"
Cohesion: 0.11
Nodes (7): DllImport, EventArgs, IntPtr, DllImport, IntPtr, Propio, WinEventProc
...
Cohesion: 0.16
Nodes (4): int, Contrato, Func, Plan

### Community 96 - "U.WindowsClient.Diagnostics"
Cohesion: 0.11
Nodes (7): U.WindowsClient.Clinical, U.WindowsClient.Uia, U.Graph.Surfaces, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.Graph, ContratoDelGrafo
...
### Community 99 - "Etapa 3 — Poner el contrato en rojo"
Cohesion: 0.33
...
### Community 108 - ".BindPressure"
Cohesion: 0.15
Nodes (13): Field, CancellationToken, IReadOnlyList, Task, ClinicalValue, HashSet, IReadOnlyList, Key (+5 more)

### Community 109 - "U.WindowsClient.SystemApi"
Cohesion: 0.22
Nodes (4): U.WindowsClient.SystemApi, IEnumerable, string, InstalledApps

### Community 110 - "Gestures"
Cohesion: 0.27
Nodes (5): byte, DllImport, uint, UIntPtr, Gestures

### Community 111 - ".RetryAllAsync"
Cohesion: 0.28
...
### Community 123 - ".Log"
Cohesion: 0.09
Nodes (21): CancellationToken, CancellationTokenSource, ClientWebSocket, ConsumoVivo, HashSet, JsonElement, LiveAudio, LiveVideo (+13 more)
...
### Community 132 - "U.WindowsClient.Voice"
Cohesion: 0.17
Nodes (4): Omi, U.WindowsClient.Voice, Fuente, Voz

### Community 133 - ".AppsConJerarquia"
Cohesion: 0.28
Nodes (6): App, Cuantas, DeHumano, Etiqueta, IReadOnlyList, Nivel

### Community 134 - ".SetStatus"
Cohesion: 0.08
Nodes (10): Action, FaceMood, KeyEventArgs, MouseButtonEventArgs, TranslateTransform, CheckUpdateBtn, DryRunBtn, MicBtn (+2 more)
...
### Community 139 - ".ReloadDirectWorkflowsAsync"
Cohesion: 0.18
Nodes (5): SelectionChangedEventArgs, WorkflowDeleteBtn, WorkflowListBox, Task, ListBox
...
### Community 144 - "Inspector visual (overlay click-through)"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (5): Dictionary, IReadOnlyDictionary, Stack, UiElement, SurfaceMapTools
...
### Community 151 - "Etapa 2 — Partir en fases"
Cohesion: 0.13
...
Cohesion: 0.18
Nodes (5): U.WindowsClient.Capture, U.WindowsClient.Telemetry, U.WindowsClient.Actions, U.WindowsClient.Mcp, U.WindowsClient.Agent
...
### Community 166 - "Ü · Backend (el cerebro)"
Cohesion: 0.16
...
Cohesion: 0.03
Nodes (58): AgentLoop, AtajoPorGolpes, BackendClient, Button, ClinicalBridge, Config, DictadoSoniox, EjecutorDeExportaciones (+50 more)

### Community 171 - ".Calcular"
Cohesion: 0.09
Nodes (18): App, Cuantas, DeHumano, Etiqueta, IReadOnlyList, Nivel, Button, Color (+10 more)

### Community 172 - ".TryResolveSourceInterface"
Cohesion: 0.35
...
### Community 174 - ".Aplicar"
Cohesion: 0.32
Nodes (4): double, IEasingFunction, Window, EdgeSnap

### Community 175 - ".AlLlegarTrama"
Cohesion: 0.32
...
Cohesion: 0.09
Nodes (13): Binding, Busqueda, Caja, U.WindowsClient.Update, Rect, Detalle, IReadOnlyList, Que (+5 more)

### Community 178 - ".AbrirAsync"
Cohesion: 0.48
...
### Community 182 - "WorkflowLibraryWindow.xaml.cs"
Cohesion: 0.26
Nodes (4): U.WindowsClient.Backend, U.WindowsClient.Domain, JsonElement, WorkflowSummary

### Community 183 - "Etapa 6 — El paso a `main`"
Cohesion: 0.29
...
### Community 184 - "El aviso — lo que se subió, contado al equipo"
Cohesion: 0.29
...
### Community 196 - "Patrones de desarrollo: cómo se escribe código aquí"
Cohesion: 0.12
...
### Community 197 - "Etapa 5 — Verificar"
Cohesion: 0.29
...
### Community 198 - "Todo push deja un aviso en `#miracle-updates`"
Cohesion: 0.33
...
### Community 199 - ".OnLoaded"
Cohesion: 0.11
Nodes (6): Point, RECT, HttpClient, ClinicalBridge, ClinicalPairBtn, Task

### Community 200 - "WorkflowDryRun.cs"
Cohesion: 0.33
Nodes (5): IEnumerable, DryRunFinding, DryRunLevel, DryRunReport, WorkflowDryRun

### Community 201 - "Ü · Cliente Windows (el frontend tonto)"
Cohesion: 0.24
...
Cohesion: 0.25
Nodes (3): ComoMePongoDelante, Plan, Via

### Community 223 - "Protocol.cs"
Cohesion: 0.50
...
Cohesion: 0.11
Nodes (13): bool, ClickWatcher, DateTime, double, Etiqueta, int, ProyectorNeo4j, SinColgarse (+5 more)

### Community 281 - "int"
Cohesion: 0.67
Nodes (3): int, POINT, RECT

### Community 310 - "InputUnion"
Cohesion: 0.67
...
## Knowledge Gaps
- **564 isolated node(s):** `ConsumoVivo`, `Hacia`, `Mapeador.Pruebas`, `Via`, `Plan` (+559 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `U.WindowsClient.Voice`, `.SetStatus`, `.OnLoaded`, `TeachSession`, `.ReloadDirectWorkflowsAsync`, `Window`, `List`, `Updater`, `Button`, `WorkflowTeachSession`, `PanelDeAcciones`, `MapaVivo`, `Window`, `.Log`, `.CrecerPastilla`, `GlobalHotkeys`, `TelemetryClient`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `U.WindowsClient.Ui` connect `U.WindowsClient.Ui` to `U.WindowsClient.Voice`, `FaceControl`, `InspectorOverlay`, `PasoAPaso`, `FaceGestures`, `.Aplicar`, `LanzarConScroll`, `WorkflowLibraryWindow.xaml.cs`, `GraphExplorerWindow`, `StepDebuggerWindow`, `Locator Badge Overlay`, `Window`, `Senalador`, `U.WindowsClient.Diagnostics`, `OnboardingWindow`, `TeachSession.cs`, `RastroDelCursor`, `U.WindowsClient.SystemApi`, `PanelDeAcciones`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `WorkflowLibraryWindow` connect `WorkflowLibraryWindow` to `GraphConfig`, `Window`, `TeachSession`, `BackendClient`, `.OnApplyMatch`, `.RunAsync`, `GraphClient`, `SapGuiSurface`, `UiaSurface`, `WorkflowLibraryWindow.xaml.cs`, `WorkflowTeachSession`, `GraphObservation`, `Window`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **What connects `ConsumoVivo`, `Hacia`, `Mapeador.Pruebas` to the rest of the system?**
