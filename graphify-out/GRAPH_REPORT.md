...
## Corpus Check
- 195 files · ~356,878 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3643 nodes · 7685 edges · 272 communities (172 shown, 100 thin omitted)
- Extraction: 96% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 267 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6133d2ed`
...
## Communities (272 total, 100 thin omitted)
...
Cohesion: 0.11
Nodes (16): AudioDevice, IAsyncDisposable, Recorder, CancellationToken, IReadOnlyList, string, Task, ValueTask (+8 more)
...
Cohesion: 0.05
Nodes (28): Config, HorizontalAlignment, SizeChangedEventArgs, SoundPlayer, TranslateTransform, FaceMood, FaceTheme, BackendBody (+20 more)

### Community 7 - "U.WindowsClient.Diagnostics"
Cohesion: 0.09
Nodes (15): U.WindowsClient.Backend, U.WindowsClient.Capture, U.WindowsClient.Uia, U.WindowsClient.Telemetry, U.Graph.Surfaces, U.WindowsClient.Navigation, U.WindowsClient.Domain, U.WindowsClient.Diagnostics (+7 more)
...
Cohesion: 0.14
Nodes (12): Channel, ObservedStep, SurfaceAvailability, CancellationToken, CancellationTokenSource, Dictionary, int, string (+4 more)
...
Cohesion: 0.15
Nodes (4): Assembly, Contrato, int, string
...
### Community 45 - "PestanasAbiertas"
Cohesion: 0.14
Nodes (12): AutomationElement, bool, Dictionary, DllImport, EnumProc, HashSet, int, IntPtr (+4 more)

### Community 46 - "SapInspectorReader"
Cohesion: 0.12
Nodes (17): ConcurrentDictionary, SapBox, Stopwatch, TreeRow, Box, double, int, IReadOnlyList (+9 more)
...
Cohesion: 0.11
Nodes (12): DateTime, EdgeInfo, HashSet, Hop, IEnumerable, EdgeBronce, EdgeInfo, Ensenanza (+4 more)
...
### Community 78 - "Window"
Cohesion: 0.09
Nodes (23): ConfidenceLabel, Label, Value, TextChangedEventArgs, AutofillStatus, ConnStatus, ForceSurface, MatchesList (+15 more)

### Community 79 - "Ventana"
Cohesion: 0.12
Nodes (14): Action, Button, CancellationToken, ContentControl, Maqueta, Programa, Ventana, Porque (+6 more)
...
Cohesion: 0.11
Nodes (12): Canvas, Dictionary, From, int, List, Rect, Rectangle, To (+4 more)
...
### Community 104 - ".Log"
Cohesion: 0.10
Nodes (12): AppInstalada, Color, IReadOnlyDictionary, Task, UpdateManager, VelopackAsset, Aristas, Nodos (+4 more)
...
Cohesion: 0.13
Nodes (6): U.WindowsClient.Ui, IEasingFunction, MuelleEase, Pantallas, ProfundidadClasica, ThrowEase

### Community 110 - ".EnsureAsync"
Cohesion: 0.36
...
### Community 116 - "Screenshotter"
Cohesion: 0.36
Nodes (5): DllImport, int, IntPtr, RECT, Screenshotter
...
### Community 134 - ".Edges"
Cohesion: 0.12
Nodes (11): Alternatives, ControlType, Grupo, Info, Label, Selector, From, HashSet (+3 more)
...
### Community 143 - "Bronce"
Cohesion: 0.29
Nodes (5): BronceApp, Bronce, BronceApp, Pantalla, Puerta

### Community 144 - ".OnLoaded"
Cohesion: 0.09
Nodes (12): CancellationToken, HttpClient, IReadOnlyList, Task, ClinicalBridge, CollapsedFace, Face, IReadOnlyList (+4 more)
...
Cohesion: 0.08
Nodes (22): bool, Border, CancellationTokenSource, CarruselDeApps, DispatcherTimer, DllImport, DockPanel, EventArgs (+14 more)
...
### Community 157 - ".EjecutarNucleoAsync"
Cohesion: 0.31
...
### Community 165 - "Ventana"
Cohesion: 0.25
Nodes (6): Button, Color, TaskCompletionSource, TextBlock, TextBox, Ventana

### Community 166 - ".LoQueSenala"
Cohesion: 0.17
Nodes (6): Caja, Point, Que, Func, IReadOnlyList, Rect
...
### Community 173 - "SurfaceMap"
Cohesion: 0.10
Nodes (17): Aristas, Click, ClickWatcher, NodeInfo, Nodos, DateTime, Dictionary, int (+9 more)

### Community 174 - "RoutedEventArgs"
Cohesion: 0.09
Nodes (3): CancellationToken, RoutedEventArgs, Task

### Community 175 - "FocusRunningStrategy"
Cohesion: 0.44
...
## Knowledge Gaps
- **427 isolated node(s):** `net8.0-windows`, `Microsoft.NET.Sdk`, `Maqueta`, `VistaGrafo`, `CONTINUAR` (+422 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `TeachSession`, `ClickWatcher`, `U.WindowsClient.Diagnostics`, `Window`, `UiaReader`, `.OnLoaded`, `GraphClient`, `SapGuiSurface`, `AtajoPorGolpes`, `GraphExplorerWindow`, `WorkflowMapWindow`, `.SetDirectIndex`, `UiaSurface`, `AgentLoop`, `SurfaceMap`, `.OnInputKey`, `RoutedEventArgs`, `UiInspector`, `.CrecerPastilla`, `GlobalHotkeys`, `TelemetryClient`, `WorkflowLibraryWindow`, `VideoLibraryWindow`, `StepDebuggerWindow`, `LogWindow`, `Locator Badge Overlay`, `GraphObservation`, `VoiceIO`, `.Log`, `BackendClient`, `Window`, `PanelDeAcciones`, `GeminiLive`?**
  _High betweenness centrality (0.229) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `.ReadTreeSelections`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `WorkflowLibraryWindow`, `dynamic`, `FaceWindow`, `U.WindowsClient.Diagnostics`, `.Session`, `.Str`, `SapInspectorReader`, `AtajoPorGolpes`, `AgentLoop`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `UiaSurface` connect `UiaSurface` to `GraphCrawler`, `IUiSurface`, `WorkflowLibraryWindow`, `.GetForegroundWindow`, `FaceWindow`, `U.WindowsClient.Diagnostics`, `AutomationElement`, `.Describe`, `UiaSelector`, `IntPtr`, `WorkflowRecorder`, `AgentLoop`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **What connects `net8.0-windows`, `Microsoft.NET.Sdk`, `Maqueta` to the rest of the system?**
