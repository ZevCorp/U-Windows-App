...
## Corpus Check
- 237 files · ~428,175 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4403 nodes · 9121 edges · 315 communities (205 shown, 110 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 486 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ff18aee`
...
## Communities (315 total, 110 thin omitted)
...
Cohesion: 0.12
Nodes (16): Contrato, Assembly, int, STAThread, string, DateTime, Dictionary, int (+8 more)

### Community 7 - "TeachSession"
Cohesion: 0.06
Nodes (32): AudioDevice, Recorder, CancellationToken, IReadOnlyList, string, Task, ValueTask, ScreenRecorder (+24 more)

### Community 8 - "Etapa 6 — El paso a `main`"
Cohesion: 0.05
Nodes (37): El destino es fijo, y no se pregunta, La regla, Lo que el agente no hace, Qué lleva el mensaje, Su límite honesto, Todo push deja un aviso en `#miracle-updates`, El PR, La compuerta: qué tiene que ser cierto para que algo entre a `main` (+29 more)

### Community 9 - "Grafo"
Cohesion: 0.20
Nodes (9): Camino, int, List, Contrato, Dictionary, IReadOnlyList, object, Camino (+1 more)
...
Cohesion: 0.17
Nodes (9): byte, TimeSpan, uint, ShellLaunchStrategy, ShowDesktopStrategy, StartMenuLaunchStrategy, TimeSpan, INavStrategy (+1 more)

### Community 22 - ".ShowTalk"
Cohesion: 0.12
Nodes (5): DryRunBtn, RunWorkflowBtn, TeachBtn, CancellationToken, Task
...
Cohesion: 0.07
Nodes (26): Channel, EventHandler, IAsyncDisposable, ValueTask, CancellationToken, DllImport, int, IntPtr (+18 more)
...
### Community 43 - "AgentLoop (compuerta de origen)"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (21): DockPanel, NarradorDelArquitecto, Screen, ScrollViewer, VistaGrafo, bool, Border, Button (+13 more)
...
Cohesion: 0.22
Nodes (5): Nucleo.Pruebas, Nucleo, List, Alcanzable, Elemento

### Community 65 - ".BindPressure"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (27): Escritos, SinLlenar, CancellationToken, CancellationTokenSource, Dispatcher, Func, HttpClient, HttpRequestMessage (+19 more)
...
### Community 99 - "FocusRunningStrategy"
Cohesion: 0.29
Nodes (6): CancellationToken, DllImport, int, IntPtr, Task, FocusRunningStrategy
...
Cohesion: 0.11
Nodes (19): CancellationTokenSource, ClientWebSocket, ConsumoVivo, DateTime, double, HashSet, LiveAudio, LiveVideo (+11 more)
...
Cohesion: 0.12
Nodes (11): MouseButtonEventArgs, MouseEventArgs, Rectangle, SolidColorBrush, CollapsedGroup, MicBtn, RootPanel, ZonaChat (+3 more)
...
Cohesion: 0.07
Nodes (27): RoutedEventArgs, AprendizajeBtn, AutonomoBtn, CheckUpdateBtn, CollarBtn, CollarModoBtn, ExplorerBtn, FullTooltipsBtn (+19 more)
...
### Community 139 - ".EjecutarNucleoAsync"
Cohesion: 0.26
Nodes (3): CancellationToken, JsonElement, IReadOnlyDictionary
...
### Community 144 - "FillPreviewWindow"
Cohesion: 0.25
Nodes (5): Brush, Button, Task, TaskCompletionSource, FillPreviewWindow
...
### Community 148 - ".Log"
Cohesion: 0.06
Nodes (24): Caja, Rect, Dictionary, DllImport, EnumProc, IntPtr, List, Opciones (+16 more)
...
### Community 166 - "Arquitectura — la separación cliente / cerebro"
Cohesion: 0.22
...
Cohesion: 0.03
Nodes (53): AgentLoop, AtajoPorGolpes, BackendClient, Button, ClinicalBridge, Config, DictadoSoniox, EjecutorDeExportaciones (+45 more)

### Community 171 - ".Calcular"
Cohesion: 0.11
Nodes (16): Cromo, App, Cuantas, DeHumano, Etiqueta, IReadOnlyList, Nivel, Nivel (+8 more)

### Community 173 - ".DibujarConProfundidad"
Cohesion: 0.18
Nodes (7): Dictionary, Etiqueta, From, IEnumerable, List, To, UiElement

### Community 174 - ".TryResolveSourceInterface"
Cohesion: 0.35
...
Cohesion: 0.12
Nodes (9): Busqueda, U.WindowsClient.Update, Detalle, Que, TimeSpan, UpdateManager, VelopackAsset, Busqueda (+1 more)
...
### Community 183 - ".SetDirectIndex"
Cohesion: 0.17
Nodes (6): SelectionChangedEventArgs, WorkflowListBox, WorkflowNext, WorkflowPrev, WorkflowViewToggle, ListBox

### Community 184 - "config.ts"
Cohesion: 0.30
...
Cohesion: 0.04
Nodes (43): Declarar antes de pedir permiso, Después de tocarlo, El núcleo está congelado, Lo protegido, Su límite honesto, 10. Un paso no ejecutado deja rastro, 11. No anclar rutas al nombre de la carpeta del repo, 12. Enlace tardío siempre para COM (+35 more)

### Community 197 - ".NivelDe"
Cohesion: 0.20
Nodes (4): Visual, Point, Rect, Pantallas

### Community 198 - "CarruselDeApps"
Cohesion: 0.20
Nodes (8): ImageSource, IReadOnlyList, List, Task, TextBox, UIElement, CarruselDeApps, WrapPanel

### Community 199 - ".OnLoaded"
Cohesion: 0.09
Nodes (11): Binding, IReadOnlyList, Point, RECT, HttpClient, ClinicalBridge, double, IEasingFunction (+3 more)

### Community 200 - ".Analyze"
Cohesion: 0.16
Nodes (8): List, RunTimings, IEnumerable, IReadOnlyList, DryRunFinding, DryRunLevel, DryRunReport, WorkflowDryRun

### Community 201 - ".UpdateChip"
Cohesion: 0.27
...
### Community 207 - ".Todas"
Cohesion: 0.20
Nodes (5): U.WindowsClient.Onboarding, string, Presentacion, IReadOnlyList, AppInstalada

### Community 209 - ".EstaDelante"
Cohesion: 0.38
Nodes (3): DllImport, IntPtr, UIntPtr

### Community 214 - ".EnsureAsync"
Cohesion: 0.42
...
Cohesion: 0.12
Nodes (9): bool, ClickWatcher, Etiqueta, int, ProyectorNeo4j, SinColgarse, string, Timer (+1 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `Button`, `.OnLoaded`, `.UpdateChip`, `Window`, `Window`, `.Log`, `.ShowTalk`, `.SetDirectIndex`, `MapaVivo`, `U.WindowsClient.Voice`, `PanelDeAcciones`, `GeminiLive`, `.CrecerPastilla`, `GlobalHotkeys`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `U.WindowsClient.Ui` connect `U.WindowsClient.Ui` to `FaceControl`, `FillPreviewWindow`, `InspectorOverlay`, `Window`, `FaceGestures`, `LanzarConScroll`, `OlvidarJerarquias`, `WorkflowLibraryWindow.xaml.cs`, `.NivelDe`, `.OnLoaded`, `StepDebuggerWindow`, `Locator Badge Overlay`, `U.WindowsClient.Voice`, `Senalador`, `U.WindowsClient.Diagnostics`, `OnboardingWindow`, `TeachSession.cs`, `RastroDelCursor`, `U.WindowsClient.SystemApi`, `PanelDeAcciones`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `U.WindowsClient.Diagnostics`, `.ReadFields`, `IUiSurface`, `SapComEvents`, `.Str`, `.Session`, `.ReadTreeSelections`, `RellenadorSap`, `.PumpMain`, `SapInspectorReader`, `.Walk`, `WorkflowLibraryWindow`, `dynamic`, `AgentLoop`?**
