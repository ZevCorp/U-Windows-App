...
## Corpus Check
- 195 files · ~357,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3658 nodes · 7722 edges · 266 communities (164 shown, 102 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 267 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9be8db46`
...
## Communities (266 total, 102 thin omitted)

### Community 0 - ".Log"
Cohesion: 0.10
Nodes (25): Alternativas, Entrable, Frente, Queue, Tipo, bool, CancellationToken, DllImport (+17 more)
...
### Community 6 - ".UpdateChip"
Cohesion: 0.12
Nodes (6): TranslateTransform, FaceMood, FaceTheme, DllImport, IntPtr, UIElement

### Community 7 - "U.WindowsClient.Diagnostics"
Cohesion: 0.08
Nodes (11): U.WindowsClient.Backend, U.WindowsClient.Ui, U.WindowsClient.Clinical, U.WindowsClient.Navigation, U.WindowsClient.Diagnostics, U.WindowsClient.Teach, U.WindowsClient.Voice, U.WindowsClient.SystemApi (+3 more)
...
Cohesion: 0.10
Nodes (9): U.WindowsClient.Capture, U.WindowsClient.Uia, U.Graph.Surfaces, U.WindowsClient.Domain, U.WindowsClient.Actions, U.WindowsClient.Mcp, U.WindowsClient.Agent, IEnumerable (+1 more)
...
Cohesion: 0.11
Nodes (11): DateTime, HashSet, Hop, List, EdgeBronce, EdgeInfo, Ensenanza, Hop (+3 more)
...
Cohesion: 0.08
Nodes (19): Action, Brush, Button, CancellationToken, ContentControl, Maqueta, Func, Fila (+11 more)
...
Cohesion: 0.10
Nodes (8): Dictionary, From, Rect, To, Visual, Point, Rect, Pantallas
...
### Community 134 - ".Edges"
Cohesion: 0.11
Nodes (7): EdgeInfo, Info, From, HashSet, IEnumerable, List, To
...
Cohesion: 0.07
Nodes (25): bool, Border, CancellationTokenSource, Canvas, CarruselDeApps, DispatcherTimer, DllImport, DockPanel (+17 more)

### Community 152 - ".ArrancarAsync"
Cohesion: 0.23
...
Cohesion: 0.25
Nodes (5): Caja, Point, Que, IReadOnlyList, Rect
...
Cohesion: 0.07
Nodes (19): Config, HorizontalAlignment, SoundPlayer, ValueTask, bool, CancellationToken, CancellationTokenSource, Color (+11 more)
...
## Knowledge Gaps
- **428 isolated node(s):** `Maqueta`, `Fila`, `net8.0-windows`, `Microsoft.NET.Sdk`, `VistaGrafo` (+423 more)
...
- **What is the exact relationship between `Fiabilidad de eventos (controles Win32 no siempre notifican)` and `Issues dotnet/winforms#7763 y dotnet/wpf#9382`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `FaceWindow` connect `FaceWindow` to `SurfaceLocator`, `TeachSession`, `ClickWatcher`, `.UpdateChip`, `U.WindowsClient.Diagnostics`, `Window`, `UiaReader`, `.OnLoaded`, `GraphClient`, `SapGuiSurface`, `GraphExplorerWindow`, `WorkflowMapWindow`, `.SetDirectIndex`, `UiaSurface`, `WorkflowTeachSession`, `AgentLoop`, `Updater`, `.ApplyBarSide`, `SurfaceMap`, `.OnInputKey`, `.WireMenu`, `UiInspector`, `AtajoPorGolpes`, `.CrecerPastilla`, `GlobalHotkeys`, `TelemetryClient`, `WorkflowLibraryWindow`, `StepDebuggerWindow`, `LogWindow`, `Locator Badge Overlay`, `GraphObservation`, `VoiceIO`, `BackendClient`, `Window`, `PanelDeAcciones`, `GeminiLive`?**
  _High betweenness centrality (0.221) - this node is a cross-community bridge._
- **Why does `SapGuiSurface` connect `SapGuiSurface` to `U.Graph.Surfaces`, `.PumpMain`, `SurfaceLocator`, `IUiSurface`, `WorkflowLibraryWindow`, `List`, `dynamic`, `.ReadTreeSelections`, `.Str`, `SapInspectorReader`, `FaceWindow`, `SapComEvents`, `.Walk`, `AgentLoop`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `UiaSurface` connect `UiaSurface` to `.Log`, `U.Graph.Surfaces`, `IUiSurface`, `WorkflowLibraryWindow`, `.GetForegroundWindow`, `AutomationElement`, `FaceWindow`, `.Describe`, `UiaSelector`, `IntPtr`, `WorkflowTeachSession`, `AgentLoop`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **What connects `Maqueta`, `Fila`, `net8.0-windows` to the rest of the system?**
